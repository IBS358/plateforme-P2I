...
const MACHINES_DATA = {
  ...
  huiles_alimentaires: {
    ...
    machines: [
      ...
      { name: "Raffineur continu", role: "Raffinage de l'huile brute", capacity: "500 kg/h", utilities: "Électricité", price: 18000 },
      { name: "Désodoriseur sous vide", role: "Élimination des odeurs", capacity: "300 kg/batch", utilities: "Électricité + vapeur", price: 12500 },
      { name: "Filtre presse", role: "Filtration", capacity: "20 m²", utilities: "Électricité", price: 8000 },
      { name: "Ligne conditionnement", role: "Conditionnement", capacity: "1000 b/h", utilities: "Électricité", price: 6500 }
    ]
  },
  epices: {
    ...
    machines: [
      ...
      { name: "Broyeur", role: "Broyage", capacity: "Standard", utilities: "Électricité", price: 5000 },
      { name: "Tamis", role: "Tamisage", capacity: "Standard", utilities: "Électricité", price: 3000 },
      { name: "Mélangeur", role: "Assemblage de mélanges", capacity: "Option", utilities: "Électricité", price: 4000 },
      { name: "Ensacheuse", role: "Conditionnement", capacity: "Semi-automatique", utilities: "Électricité", price: 6000 }
    ]
  },
  aliments_betail: {
...
smartphones: {
  ...
  machines: [
    { name: "Ligne SMT", role: "CMS cartes mères", capacity: "50000 comp/heure", utilities: "Électricité 20kW", price: 200000 },
    { name: "Four refusion", role: "Brasage CMS", capacity: "Standard", utilities: "Électricité", price: 40000 },
    { name: "Robot encollage", role: "Pose glue", capacity: "200 cartes/heure", utilities: "Air comprimé", price: 50000 },
    { name: "Presse écran", role: "Montage écran", capacity: "100 smartphones/heure", utilities: "Air comprimé", price: 30000 },
    { name: "Testeur fonctionnel", role: "Tests complets", capacity: "80 smartphones/heure", utilities: "Électricité", price: 60000 },
    { name: "Machine à étiqueter IMEI", role: "Marquage IMEI", capacity: "100 smartphones/heure", utilities: "Électricité", price: 15000 },
    { name: "Poste contrôle optique", role: "Auto-inspection", capacity: "100 smartphones/heure", utilities: "Électricité", price: 40000 }
  ]
},
...
ordinateurs: {
  ...
  machines: [
    { name: "Poste assemblage", role: "Montage manuel", capacity: "100 PC/jour", utilities: "Standard", price: 10000 },
    { name: "Machine à visser", role: "Vissage automatique", capacity: "50 PC/heure", utilities: "Air comprimé", price: 20000 },
    { name: "Testeur alimentation", role: "Test PSU", capacity: "50 PC/heure", utilities: "Électricité", price: 15000 },
    { name: "Testeur mémoire RAM", role: "Test RAM", capacity: "100 barrettes/heure", utilities: "Électricité", price: 12000 },
    { name: "Brûleur BIOS", role: "Flash BIOS", capacity: "50 PC/heure", utilities: "Électricité", price: 10000 },
    { name: "Configuration OS", role: "Installation OS", capacity: "50 PC/heure", utilities: "Électricité", price: 15000 },
    { name: "Poste emballage", role: "Conditionnement", capacity: "50 PC/heure", utilities: "Électricité", price: 8000 }
  ]
},
...
electromenager: {
  ...
  machines: [
    { name: "Presse pliage tôle", role: "Fabrication coque", capacity: "200 pièces/jour", utilities: "Électricité 15kW", price: 50000 },
    { name: "Poste soudure", role: "Soudure carcasse", capacity: "100 pièces/jour", utilities: "Électricité", price: 20000 },
    { name: "Ligne peinture", role: "Peinture", capacity: "200 pièces/jour", utilities: "Électricité", price: 40000 },
    { name: "Chaîne assemblage", role: "Montage", capacity: "100 appareils/jour", utilities: "Électricité + air", price: 60000 },
    { name: "Machine à mousser", role: "Injection mousse", capacity: "100 appareils/jour", utilities: "Air comprimé", price: 35000 },
    { name: "Testeur fonctionnel", role: "Test performance", capacity: "60 appareils/heure", utilities: "Électricité", price: 30000 },
    { name: "Poste emballage", role: "Conditionnement", capacity: "80 appareils/heure", utilities: "Électricité", price: 15000 }
  ]
},
...
climatiseurs: {
  up_nom: "Climatiseurs",
  machines: [
    { name: "Ligne cintrage tubes", role: "Fabrication échangeurs", capacity: "200 échangeurs/jour", utilities: "Électricité 10kW", price: 50000 },
    { name: "Poste brasage", role: "Brasage cuivre", capacity: "100 échangeurs/jour", utilities: "Gaz + électricité", price: 20000 },
    { name: "Machine à assembler", role: "Montage", capacity: "100 climatiseurs/jour", utilities: "Air comprimé", price: 40000 },
    { name: "Poste recharge gaz", role: "Chargement fluide", capacity: "100 climatiseurs/jour", utilities: "Vide + balance", price: 30000 },
    { name: "Testeur fuites", role: "Test étanchéité", capacity: "100 climatiseurs/jour", utilities: "Électricité", price: 25000 },
    { name: "Banc de test", role: "Test performance", capacity: "50 climatiseurs/jour", utilities: "Électricité", price: 40000 },
    { name: "Poste emballage", role: "Conditionnement", capacity: "80 climatiseurs/jour", utilities: "Électricité", price: 15000 }
  ]
},
...
motos: {
  ...
  machines: [
    { name: "Ligne soudure cadre", role: "Soudure châssis", capacity: "50 cadres/jour", utilities: "Électricité 15kW", price: 60000 },
    { name: "Cabine peinture", role: "Peinture", capacity: "50 cadres/jour", utilities: "Électricité", price: 40000 },
    { name: "Chaîne assemblage", role: "Montage", capacity: "50 motos/jour", utilities: "Air comprimé", price: 80000 },
    { name: "Poste pause moteur", role: "Installation moteur", capacity: "50 motos/jour", utilities: "Pont roulant", price: 20000 },
    { name: "Machine à monter roues", role: "Montage roues", capacity: "50 motos/jour", utilities: "Air comprimé", price: 15000 },
    { name: "Banc de roulage", role: "Test final", capacity: "30 motos/jour", utilities: "Électricité", price: 50000 },
    { name: "Poste emballage", role: "Conditionnement", capacity: "50 motos/jour", utilities: "Électricité", price: 25000 }
  ]
},
...
velos: {
  up_nom: "Bicyclettes",
  machines: [
    { name: "Poste soudure cadre", role: "Soudure", capacity: "100 cadres/jour", utilities: "Électricité 8kW", price: 30000 },
    { name: "Cabine peinture", role: "Peinture", capacity: "100 cadres/jour", utilities: "Électricité", price: 25000 },
    { name: "Chaîne assemblage", role: "Montage", capacity: "100 vélos/jour", utilities: "Air comprimé", price: 40000 },
    { name: "Machine à montrer roues", role: "Montage roues", capacity: "100 vélos/jour", utilities: "Air comprimé", price: 15000 },
    { name: "Poste réglage", role: "Réglage transmission", capacity: "100 vélos/jour", utilities: "Standard", price: 10000 },
    { name: "Banc de contrôle", role: "Test freinage", capacity: "80 vélos/jour", utilities: "Électricité", price: 20000 },
    { name: "Poste emballage", role: "Conditionnement", capacity: "100 vélos/jour", utilities: "Électricité", price: 15000 }
  ]
},
...
meubles: {
  up_nom: "Meubles",
  machines: [
    { name: "Scie à panneau", role: "Découpe panneaux", capacity: "200 m²/heure", utilities: "Électricité 10kW", price: 40000 },
    { name: "Défonceuse CNC", role: "Usinage", capacity: "100 pièces/heure", utilities: "Électricité 9kW", price: 50000 },
    { name: "Chants", role: "Pose chant", capacity: "200 m/heure", utilities: "Électricité + colle", price: 25000 },
    { name: "Pointeuse", role: "Perçage chevilles", capacity: "200 pièces/heure", utilities: "Air comprimé", price: 20000 },
    { name: "Chaîne assemblage", role: "Montage", capacity: "100 meubles/jour", utilities: "Air comprimé", price: 30000 },
    { name: "Presse à lamellé", role: "Collage lamellé", capacity: "100 pièces/jour", utilities: "Air comprimé", price: 15000 },
    { name: "Poste emballage", role: "Conditionnement", capacity: "100 meubles/jour", utilities: "Électricité", price: 15000 }
  ]
},
...
equipements: {
  ...
  machines: [
    { name: "Chaîne polyvalente", role: "Assemblage divers", capacity: "500 pièces/jour", utilities: "Électricité + air", price: 50000 },
    { name: "Poste soudure", role: "Soudure", capacity: "200 pièces/jour", utilities: "Électricité", price: 15000 },
    { name: "Poste rivetage", role: "Rivetage", capacity: "500 rivets/heure", utilities: "Air comprimé", price: 10000 },
    { name: "Cabine peinture", role: "Peinture", capacity: "300 pièces/jour", utilities: "Électricité", price: 30000 },
    { name: "Testeur produit", role: "Test fonctionnel", capacity: "200 pièces/jour", utilities: "Électricité", price: 20000 },
    { name: "Poste contrôle", role: "Contrôle qualité", capacity: "Standard", utilities: "Électricité", price: 10000 },
    { name: "Ensacheuse", role: "Conditionnement", capacity: "300 sachets/heure", utilities: "Électricité", price: 12000 }
  ]
},
